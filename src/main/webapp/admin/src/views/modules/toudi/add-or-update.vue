    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公司名称" prop="gongshiName">
                       <el-input v-model="ruleForm.gongshiName"
                                 placeholder="公司名称" clearable  :readonly="ro.gongshiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="公司名称" prop="gongshiName">
                           <el-input v-model="ruleForm.gongshiName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="公司地址" prop="gongshiAddress">
                       <el-input v-model="ruleForm.gongshiAddress"
                                 placeholder="公司地址" clearable  :readonly="ro.gongshiAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="公司地址" prop="gongshiAddress">
                           <el-input v-model="ruleForm.gongshiAddress"
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="就业时间" prop="toudiTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.toudiTime"
                                type="datetime"
                                placeholder="就业时间"
                                :disabled="ro.toudiTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.toudiTime" label="就业时间" prop="toudiTime">
                            <span v-html="ruleForm.toudiTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
