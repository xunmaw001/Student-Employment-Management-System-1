            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '公司名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.gongshiName" placeholder="公司名称" clearable></el-input>
                     </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xueshengjiuyeguanlix/upload/toudiMuBan.xls"
                        >批量导入就业信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('toudi','导入导出')"
                                style="display: inline-block"
                                action="xueshengjiuyeguanlix/file/upload"
    ...
    //当前表下拉框搜索条件
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.jiuyeTypes!= '' && this.searchForm.jiuyeTypes!= undefined) {
                    params['jiuyeTypes'] = this.searchForm.jiuyeTypes
                }
                                                                 
                if (this.searchForm.gongshiName!= '' && this.searchForm.gongshiName!= undefined) {
                    params['gongshiName'] = '%' + this.searchForm.gongshiName + '%'
                }
                ...
                //查询级联表搜索条件所有列表
                this.$http({
                    url: "dictionary/page?dicCode=jiuye_types&page=1&limit=100",
                    method: "get",
                    page: 1,
                    limit: 100,
                }).then(({data}) => {
                    if(data && data.code === 0){
                        this.jiuyeTypesSelectSearch = data.data.list;
                    }
                });
                //查询当前表搜索条件所有列表
            },
