        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="就业状态" prop="jiuyeTypes">
                        <el-select v-model="ruleForm.jiuyeTypes" :disabled="ro.jiuyeTypes" placeholder="请选择就业状态">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="就业状态" prop="jiuyeValue">
                        <el-input v-model="ruleForm.jiuyeValue"
