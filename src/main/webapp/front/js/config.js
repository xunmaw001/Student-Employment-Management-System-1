...
var centerMenu = [
    ...
    ,{
        name: '职位收藏',
        url: '../zhaopinCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '公司',
        url: './pages/gongsi/list.html'
    },
    {
        name: '简历',
        url: './pages/jianli/list.html'
    },
    {
        name: '公告信息',
    ...
    {
        name: '职位招聘',
        url: './pages/zhaopin/list.html'
    },

]

var adminurl =  "http://localhost:8080/xueshengjiuyeguanlix/admin/dist/index.html#/login";
